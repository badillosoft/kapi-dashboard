    ...
    const form = (
        <>
            ...
            <div className="p-3 border">
                ...
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>valor</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
                        <input className="form-control" required />
                    </div>
...
export default props => {
    ...
    return (
        <div className="d-flex flex-column container py-3 vh-100 overflow-hidden">
            <h1>Módulo de <span className="text-primary">{"impuestos".toUpperCase()}</span></h1>
            <div className="d-flex justify-content-between mb-2">
                <span>Tabla de {"impuestos"}</span>
                <span>Total: 0</span>
                {
                    !panelOpen ? (
                        <div className="d-flex" onClick={() => {
                            ...
                            <span className="mr-2"><strong>Nuevo {"impuesto"}</strong></span>
