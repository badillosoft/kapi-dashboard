    ...
    const form = (
        <>
            ...
            <div className="p-3 border">
                ...
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>numero</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
            ...
            <div className="p-3 border">
                ...
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>ultimacompra</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
                ...
                <div className="d-flex justify-content-end align-items-center mb-2">
                    <span className="mr-2">principal</span>
                    <input type="checkbox"  />
                </div>
            </div>
        </>
    ...
    return (
        <div className="flex-grow-1 d-flex flex-column border p-3 overflow-hidden">
            <div className="d-flex justify-content-between border-bottom w-100">
                <h1>Nuevo {"producto_proveedor"}</h1>
...
export default props => {
    ...
    return (
        <div className="d-flex flex-column container py-3 vh-100 overflow-hidden">
            <h1>Módulo de <span className="text-primary">{"producto_proveedor".toUpperCase()}</span></h1>
            <div className="d-flex justify-content-between mb-2">
                <span>Tabla de {"producto_proveedor"}</span>
                <span>Total: 0</span>
                {
                    !panelOpen ? (
                        <div className="d-flex" onClick={() => {
                            ...
                            <span className="mr-2"><strong>Nuevo {"producto_proveedor"}</strong></span>
