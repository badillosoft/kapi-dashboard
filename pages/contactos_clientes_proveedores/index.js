...
const DoFormularioNuevo = props => {
    ...
    const name = "contactos_clientes_proveedores";
    ...
    const form = (
        <>
            ...
            <div className="p-3 border">
                ...
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>email</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
                        <input className="form-control" required />
                    </div>
                ...
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>celular</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
                        <input className="form-control" required />
                    </div>
                ...
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>f_nacimiento</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
            ...
            <div className="p-3 border">
                <div className="d-flex mb-2 align-items-center">
                    <div className="mr-2"><code>id</code></div>
                    <div className="flex-grow-1 ml-2 border-top" />
                    <div className="">
    ...
    return (
        <div className="flex-grow-1 d-flex flex-column border p-3 overflow-hidden">
            <div className="d-flex justify-content-between border-bottom w-100">
                <h1>Nuevo {"contactos_clientes_proveedor"}</h1>
...
export default props => {
    ...
    return (
        <div className="d-flex flex-column container py-3 vh-100 overflow-hidden">
            <h1>Módulo de <span className="text-primary">{"contactos_clientes_proveedores".toUpperCase()}</span></h1>
            <div className="d-flex justify-content-between mb-2">
                <span>Tabla de {"contactos_clientes_proveedores"}</span>
                <span>Total: 0</span>
                {
                    !panelOpen ? (
                        <div className="d-flex" onClick={() => {
                            ...
                            <span className="mr-2"><strong>Nuevo {"contactos_clientes_proveedor"}</strong></span>
